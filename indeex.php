...
<body>
    <header>
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row">
                <div class="col-lg-4" id="hlpf_Logo"><img src="Images/logo.png"><br>Logo</div>
                <div class="col-lg-4" id="hlpf_countdown"><img src="Images/logo.png"><br>Countdown</div>
                <div class="col-lg-4" id="hlpf_Login"><img src="Images/logo.png"><br>Login</div>
                </div>
            </div>
        </div>
        <!-- Top end -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 hlpf_newsborder hlpf_min_large_height_news">
                <div class="row">
                    <div class="col-lg-12">
                        <p>
                        Hvad er Lorem Ipsum?
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <img src="Images/facebool_like.png">
                    </div>
                </div>
            </div>
            <div class="col-lg-2"></div>
            <div class="col-lg-5 hlpf_newsborder hlpf_min_large_height_news">eveevevrrbwrvsdv</div>
        </div>
    </div>
