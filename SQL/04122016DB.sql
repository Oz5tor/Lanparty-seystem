...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2016 at 10:01 PM
...
CREATE TABLE `zipcodes` (
  `zipcode` smallint(4) UNSIGNED NOT NULL DEFAULT '0',
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT ''
...
(7980, 'Vils'),
(7990, 'Øster Assels'),
(7992, 'Sydjylland/Fyn USF'),
(7993, 'Sydjylland/Fyn USF'),
(7999, 'Kommunepost'),
(8000, 'Århus C'),
(8011, 'Århus C'),
(8100, 'Århus C'),
