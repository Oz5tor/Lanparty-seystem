...
<div class="row thumbnail">
  ...
  <div class="col-lg-12">
    ...
    <div class="form-group form-inline col-lg-3 col-lg-offset-3">
      <label for="HNavn">*Hold Navn: </label>
      <input class="form-control" type="text" id="HNavn" value="" required name="HNavn">
    </div>
  ...
  <div class=" col-lg-6 col-lg-offset-3">
    ...
    <select size="5" required class="form-control" name="TeamList[]" id="TeamMembers" multiple="multiple"></select>
      <option> </option>
          ...
          function selectAll()
            {
              selectBox = document.getElementById("TeamMembers");
                var SelectedNum = selectBox.options.selected.length;
              if (SelectedNum < <?= $MaxTeamSize; ?>){
                  confirm("Der er ikke nok Spillere på holdet");
                  }else if (SelectedNum < <?= $MaxTeamSize; ?>){
                    confirm("Der er for mange Spillere på holdet");
              }else  {
